              ...
              <table class="table table-striped table-bordered" cellpadding="0" cellspacing="0" border="0"  >
                   <tbody v-for="order in orders">
                        ...
                        <td data-toggle="collapse" data-target="#collapsedRow1"> {{ order.id }} </td>
                             ...
                             <td v-else-if="order.status=='SHIPPING'" data-toggle="collapse" data-target="#collapsedRow1"> Nedostavljena </td>
                             ...
                             <td v-if="order.status=='AWAITING_DELIVERER'"><button id="pz" @click = "sendRequest(order)">Pošalji zahtjev</button></td>
