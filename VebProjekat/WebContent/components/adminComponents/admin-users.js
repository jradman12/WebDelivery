  ...
  computed: {
    filteredUsers: function () {
      return this.users.filter((c) => {
        ...
        return (
          c.username.toLowerCase().indexOf(this.filter.toLowerCase()) >= 0 ||
          c.fistName.toLowerCase().indexOf(this.filter.toLowerCase()) >= 0 ||
          c.lastName.toLowerCase().indexOf(this.filter.toLowerCase()) >= 0
        );
      });
    },
    filterRole() {
